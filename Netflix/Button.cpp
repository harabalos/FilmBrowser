...
Button::Button(float x_pos, float y_pos, float r_color, float g_color, float b_color,std::string genre)
...
void Button::draw()
{
	...
	graphics::drawRect(x_pos,y_pos,36,12,br);
	br.fill_color[0] = 0.0f;
	br.fill_color[1] = 0.0f;
	br.fill_color[2] = 0.0f;
	graphics::setFont(ASSET_PATH"OpenSans-Light.ttf");
	graphics::drawText(x_pos-15, y_pos+5, 10, genre, br);
}
